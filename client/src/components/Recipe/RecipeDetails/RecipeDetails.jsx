    ...
    render() {
        ...
        return (
            <div className="recipe-details-wrapper">
                <div className="pl-4">
                    <h2 className="text-center custom-font">{recipe.title}</h2>
                    <hr />
                    <div className="row">
                                        ...
                                        <li>
                                            <div className="feature-wrap mb-3">
                                                <div className="media-body space-sm">
                                                    ...
                                                    <span className="feature-title custom-font ml-2">PREP TIME:</span>
                                        ...
                                        <li>
                                            <div className="feature-wrap mb-3">
                                                <div className="media-body space-sm">
                                                    ...
                                                    <span className="feature-title custom-font ml-2">COOK TIME:</span>
                                        ...
                                        <li>
                                            <div className="feature-wrap mb-3">
                                                <div className="media-body space-sm">
                                                    ...
                                                    <span className="feature-title custom-font ml-2">SERVING:</span>
                                        ...
                                        <li>
                                            <div className="feature-wrap mb-3">
                                                <div className="media-body space-sm">
                                                    ...
                                                    <span className="feature-title custom-font ml-2">CATEGORY:</span>
            ...
            Created on: {recipe.formattedCreatedOn}
                                </span>
                                <span className="single-meta m-2">
            ...
            <span>{recipe.authorUserName}</span>
                        ...
                        <div className="col-lg-12">
                            <hr />
                            <h4 className="custom-font">How to prepare:</h4>
